...
def verify():
    with sync_playwright() as p:
        ...
        # Select Fund A for risk analytics
        page.locator("div[data-baseweb='select']").nth(3).click()
        page.wait_for_timeout(1000)
        page.locator("li[role='option']").nth(0).click()

        page.wait_for_timeout(3000)

        page.screenshot(path="tab_risk_distribution_filled.png", full_page=True)
        browser.close()
